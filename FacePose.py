...
cam_matrix = np.float32([[653.0839, 0.0, 319.5],
                         [0.0, 653.0839, 239.5],
                         [0.0, 0.0, 1.0]])

dist_coeffs = np.float32(
    [[0.07083464], [0.0691402], [0.0], [0.0], [-1.307346]])
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                cv2.putText(frame, "X: " + "{:7.2f}".format(
                    euler_angle[0, 0]), (20, 20), cv2.FONT_HERSHEY_SIMPLEX,
                    0.75, (0, 0, 0), thickness=2)
                cv2.putText(frame, "Y: " + "{:7.2f}".format(
                    euler_angle[1, 0]), (20, 50), cv2.FONT_HERSHEY_SIMPLEX,
                    0.75, (0, 0, 0), thickness=2)
                cv2.putText(frame, "Z: " + "{:7.2f}".format(
                    euler_angle[2, 0]), (20, 80), cv2.FONT_HERSHEY_SIMPLEX,
                    0.75, (0, 0, 0), thickness=2)
